        ...
        foreach ($json->models as $key => $mod) {
            ...
            try {
                ...
                $affected = DB::table('mods')
                    ...
                    ->update(
                    [
                        'snapshotUrl' => isset($mod->snapshotUrl) ? $mod->snapshotUrl : ' ',
                        'widgetPreviewUrl' => isset($mod->widgetPreviewUrl) ? $mod->widgetPreviewUrl : ' ',
                        'privateRate' => isset($mod->privateRate) ? $mod->privateRate : 0,
                        'p2pRate' => isset($mod->p2pRate) ? $mod->p2pRate : 0,
                        'isNonNude' => isset($mod->isNonNude) ? $mod->isNonNude : false,
                        'avatarUrl' => isset($mod->avatarUrl) ? $mod->avatarUrl : ' ',
                        'isPornStar' => isset($mod->isPornStar) ? $mod->isPornStar : false,
                        'id_mod' => isset($mod->id) ? $mod->id : ' ',
                        'country' => isset($mod->country) ? $mod->country : ' ',
                        'doSpy' => isset($mod->doSpy) ? $mod->doSpy : false,
                        'doPrivate' => isset($mod->doPrivate) ? $mod->doPrivate : false,
                        'gender' => isset($mod->gender) ? $mod->gender : ' ',
                        'isHd' => isset($mod->isHd) ? $mod->isHd : false,
                        'isVr' => isset($mod->isVr) ? $mod->isVr : false,
                        'is2d' => isset($mod->is2d) ? $mod->is2d : false,
                        'isExternalApp' => isset($mod->isExternalApp) ? $mod->isExternalApp : false,
                        'isMobile' => isset($mod->isMobile) ? $mod->isMobile : false,
                        'isModel' => isset($mod->isModel) ? $mod->isModel : false,
                        'isNew' => isset($mod->isNew) ? $mod->isNew : false,
                        'isLive' => isset($mod->isLive) ? $mod->isLive : false,
                        'isOnline' => isset($mod->isOnline) ? $mod->isOnline : false,
                        'previewUrl' => isset($mod->previewUrl) ? $mod->previewUrl : ' ',
                        'previewUrlThumbBig' => isset($mod->previewUrlThumbBig) ? $mod->previewUrlThumbBig : ' ',
                        'previewUrlThumbSmall' => isset($mod->previewUrlThumbSmall) ? $mod->previewUrlThumbSmall : ' ',
                        'broadcastServer' => isset($mod->broadcastServer) ? $mod->broadcastServer : ' ',
                        'broadcastGender' => isset($mod->broadcastGender) ? $mod->broadcastGender : ' ',
                        'snapshotServer' => isset($mod->snapshotServer) ? $mod->snapshotServer : ' ',
                        'status' => isset($mod->status) ? $mod->status : ' ',
                        'topBestPlace' => isset($mod->topBestPlace) ? $mod->topBestPlace : ' ',
                        'username' => isset($mod->username) ? $mod->username : ' ',
                        'statusChangedAt' => isset($mod->statusChangedAt) ? $mod->statusChangedAt : ' ',
                        'spyRate' => isset($mod->spyRate) ? $mod->spyRate : 0,
                        'publicRecordingsRate' => isset($mod->publicRecordingsRate) ? $mod->publicRecordingsRate : 0,
                        'genderGroup' => isset($mod->genderGroup) ? $mod->genderGroup : ' ',
                        'popularSnapshotTimestamp' => isset($mod->popularSnapshotTimestamp) ? $mod->popularSnapshotTimestamp : ' ',
                        'hasGroupShowAnnouncement' => isset($mod->hasGroupShowAnnouncement) ? $mod->hasGroupShowAnnouncement : false,
                        'groupShowType' => isset($mod->groupShowType) ? $mod->groupShowType : ' ',
                        'hallOfFamePosition' => isset($mod->hallOfFamePosition) ? $mod->hallOfFamePosition : 0,
                        'snapshotTimestamp' => isset($mod->snapshotTimestamp) ? $mod->snapshotTimestamp : ' ',
                        'hlsPlaylist' => isset($mod->hlsPlaylist) ? $mod->hlsPlaylist : ' ',
                        'isAvatarApproved' => isset($mod->isAvatarApproved) ? $mod->isAvatarApproved : ' ',
                        'isTagVerified' => isset($mod->isTagVerified) ? $mod->isTagVerified : ' ',
                        'updated_at' => $date_now
                    ]
                );
                $update ++;
