            ...
            try {
                ...
                $affected = DB::table('mods')
                    ...
                    [
                        ...
                        'privateRate' => isset($mod->privateRate) ? $mod->privateRate : ' ',
                        'p2pRate' => isset($mod->p2pRate) ? $mod->p2pRate : ' ',
                        'isNonNude' => isset($mod->isNonNude) ? $mod->isNonNude : ' ',
                        'avatarUrl' => isset($mod->avatarUrl) ? $mod->avatarUrl : ' ',
                        'isPornStar' => isset($mod->isPornStar) ? $mod->isPornStar : ' ',
                        'id_mod' => isset($mod->id) ? $mod->id : ' ',
                        'country' => isset($mod->country) ? $mod->country : ' ',
                        'doSpy' => isset($mod->doSpy) ? $mod->doSpy : ' ',
                        'doPrivate' => isset($mod->doPrivate) ? $mod->doPrivate : ' ',
                        'gender' => isset($mod->gender) ? $mod->gender : ' ',
                        'isHd' => isset($mod->isHd) ? $mod->isHd : ' ',
                        'isVr' => isset($mod->isVr) ? $mod->isVr : ' ',
                        'is2d' => isset($mod->is2d) ? $mod->is2d : ' ',
                        'isExternalApp' => isset($mod->isExternalApp) ? $mod->isExternalApp : ' ',
                        'isMobile' => isset($mod->isMobile) ? $mod->isMobile : ' ',
                        'isModel' => isset($mod->isModel) ? $mod->isModel : ' ',
                        'isNew' => isset($mod->isNew) ? $mod->isNew : ' ',
                        'isLive' => isset($mod->isLive) ? $mod->isLive : ' ',
                        'isOnline' => isset($mod->isOnline) ? $mod->isOnline : ' ',
                        ...
                        'spyRate' => isset($mod->spyRate) ? $mod->spyRate : ' ',
                        'publicRecordingsRate' => isset($mod->publicRecordingsRate) ? $mod->publicRecordingsRate : ' ',
                        ...
                        'hasGroupShowAnnouncement' => isset($mod->hasGroupShowAnnouncement) ? $mod->hasGroupShowAnnouncement : ' ',
                        'groupShowType' => isset($mod->groupShowType) ? $mod->groupShowType : ' ',
                        'hallOfFamePosition' => isset($mod->hallOfFamePosition) ? $mod->hallOfFamePosition : ' ',
