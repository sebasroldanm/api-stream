        ...
        foreach ($json->models as $key => $mod) {
            ...
            try {
                ...
                $affected = DB::table('mods')
                    ...
                    ->update(
                    [
                        'snapshotUrl' => ($mod->snapshotUrl) ? $mod->snapshotUrl : ' ',
                        'widgetPreviewUrl' => ($mod->widgetPreviewUrl) ? $mod->widgetPreviewUrl : ' ',
                        'privateRate' => ($mod->privateRate) ? $mod->privateRate : ' ',
                        'p2pRate' => ($mod->p2pRate) ? $mod->p2pRate : ' ',
                        'isNonNude' => ($mod->isNonNude) ? $mod->isNonNude : ' ',
                        'avatarUrl' => ($mod->avatarUrl) ? $mod->avatarUrl : ' ',
                        'isPornStar' => ($mod->isPornStar) ? $mod->isPornStar : ' ',
                        'id_mod' => ($mod->id) ? $mod->id : ' ',
                        'country' => ($mod->country) ? $mod->country : ' ',
                        'doSpy' => ($mod->doSpy) ? $mod->doSpy : ' ',
                        'doPrivate' => ($mod->doPrivate) ? $mod->doPrivate : ' ',
                        'gender' => ($mod->gender) ? $mod->gender : ' ',
                        'isHd' => ($mod->isHd) ? $mod->isHd : ' ',
                        'isVr' => ($mod->isVr) ? $mod->isVr : ' ',
                        'is2d' => ($mod->is2d) ? $mod->is2d : ' ',
                        'isExternalApp' => ($mod->isExternalApp) ? $mod->isExternalApp : ' ',
                        'isMobile' => ($mod->isMobile) ? $mod->isMobile : ' ',
                        'isModel' => ($mod->isModel) ? $mod->isModel : ' ',
                        'isNew' => ($mod->isNew) ? $mod->isNew : ' ',
                        'isLive' => ($mod->isLive) ? $mod->isLive : ' ',
                        'isOnline' => ($mod->isOnline) ? $mod->isOnline : ' ',
                        'previewUrl' => ($mod->previewUrl) ? $mod->previewUrl : ' ',
                        'previewUrlThumbBig' => ($mod->previewUrlThumbBig) ? $mod->previewUrlThumbBig : ' ',
                        'previewUrlThumbSmall' => ($mod->previewUrlThumbSmall) ? $mod->previewUrlThumbSmall : ' ',
                        'broadcastServer' => ($mod->broadcastServer) ? $mod->broadcastServer : ' ',
                        'broadcastGender' => ($mod->broadcastGender) ? $mod->broadcastGender : ' ',
                        'snapshotServer' => ($mod->snapshotServer) ? $mod->snapshotServer : ' ',
                        'status' => ($mod->status) ? $mod->status : ' ',
                        'topBestPlace' => ($mod->topBestPlace) ? $mod->topBestPlace : ' ',
                        'username' => ($mod->username) ? $mod->username : ' ',
                        'statusChangedAt' => ($mod->statusChangedAt) ? $mod->statusChangedAt : ' ',
                        'spyRate' => ($mod->spyRate) ? $mod->spyRate : ' ',
                        'publicRecordingsRate' => ($mod->publicRecordingsRate) ? $mod->publicRecordingsRate : ' ',
                        'genderGroup' => ($mod->genderGroup) ? $mod->genderGroup : ' ',
                        'popularSnapshotTimestamp' => ($mod->popularSnapshotTimestamp) ? $mod->popularSnapshotTimestamp : ' ',
                        'hasGroupShowAnnouncement' => ($mod->hasGroupShowAnnouncement) ? $mod->hasGroupShowAnnouncement : ' ',
                        'groupShowType' => ($mod->groupShowType) ? $mod->groupShowType : ' ',
                        'hallOfFamePosition' => ($mod->hallOfFamePosition) ? $mod->hallOfFamePosition : ' ',
                        'snapshotTimestamp' => ($mod->snapshotTimestamp) ? $mod->snapshotTimestamp : ' ',
                        'hlsPlaylist' => ($mod->hlsPlaylist) ? $mod->hlsPlaylist : ' ',
                        'isAvatarApproved' => ($mod->isAvatarApproved) ? $mod->isAvatarApproved : ' ',
                        'isTagVerified' => ($mod->isTagVerified) ? $mod->isTagVerified : ' ',
                        'updated_at' => $date_now
                    ]
                );
                $update ++;
